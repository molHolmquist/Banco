...
public class Cliente {
	...
	public static void main(String[] args) {
		...
		Cliente boi = new Cliente("Boi","10101010101", "Campos do Jordão","moooo");
		Cliente bezerro = new Cliente("Boi","10101010101", "Campos do Jordão","moooo");
		System.out.println(boi.getNomeCliente());
		System.out.println(bezerro.getNomeCliente());
