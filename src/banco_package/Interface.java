...
public class Interface {
	...
	public void excluiCliente() {
		System.out.println("Os clientes existentes s�o:");
		int i = 1;
		...
		Scanner scan = new Scanner(System.in);
		System.out.println("Qual voc� deseja exlcuir?");
		int n = scan.nextInt();
		if(n <= i && n > 0) {
			i = 1;
	...
	public void criaConta() {
		...
		Scanner scan = new Scanner(System.in);
		System.out.println("Digite o n�mero do cliente para o qual deseja criar a conta:");
		int n = scan.nextInt();
		if(n <= i && n > 0) {
			i = 1;
			for(Cliente c : this.banco.getListaCliente()) {
