...
//		}
		...
		for(Cliente c: banquinho.banco.getListaCliente()) {
			System.out.println("nome dele È:"+c.getNomeCliente());
			System.out.println("cpf dele È:"+c.getCpf_cnpj());
			System.out.println("endereco dele È:"+c.getEndereco());
			System.out.println("telegone dele È:"+c.getFone());
		}
